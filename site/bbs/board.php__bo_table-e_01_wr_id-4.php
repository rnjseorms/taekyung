...
<title>중소기업기술마켓 인증서 &gt; 인증현황 | 태경산업</title>
...
<h3>인증현황</h3>
<ul>
<li class="mbd"><a href="board.php__bo_table-e_01.php">인증현황</a></li>
</ul>
...
<span class="page-title-text">인증현황</span>
<div class="page-navi">
...
<span class="sound_only">조회</span><strong><i aria-hidden="true" class="fa fa-eye"></i> 139회</strong>
<strong class="if_date"><span class="sound_only">작성일</span><i aria-hidden="true" class="fa fa-clock-o"></i> 24-07-16 18:27</strong>
</div>
</div>
<!-- 게시물 상단 버튼 시작 { -->
<div id="bo_v_top">
<ul class="btn_bo_user bo_v_com">
<li><a class="btn_b01 btn" href="board.php__bo_table-e_01.php" title="목록"><i aria-hidden="true" class="fa fa-list"></i><span class="sound_only">목록</span></a></li>
</ul>
<script>
...
<div id="bo_v_img">
<a class="view_image" href="view_image.php__bo_table-e_01_fn-30d254022a30fd641d7568a874612d3f_yzTkZ8Db_f216a454d90644df5b685a0067d970a8826f866a.jpg.php" target="_blank"><img alt="" height="970" src="../data/file/e_01/30d254022a30fd641d7568a874612d3f_yzTkZ8Db_f216a454d90644df5b685a0067d970a8826f866a.jpg" width="690"/></a></div>
<!-- 본문 내용 시작 { -->
<div id="bo_v_con"><div style="width:350px;margin-left:150px;">
<ul><li style="font-size:16px;padding:8px;line-height:180%;margin-bottom:80px;color:#fff;background-color:#ce4f17;font-weight:bold;text-align:center;">
<a href="https://www.techmarket.kr/techView.do?idx=1728" rel="nofollow noreferrer noopener" style="color:#fff;" target="_blank">인증서 바로가기</a>
</li>
</ul></div></div>
<!-- } 본문 내용 끝 -->
<!--  추천 비추천 시작 { -->
...
<ul class="bo_v_nb">
<li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-e_01_wr_id-3.php">기술평가 우수기업 인증서</a> <span class="nb_date">23.04.26</span></li> </ul>
<script>
// 글자수 제한
