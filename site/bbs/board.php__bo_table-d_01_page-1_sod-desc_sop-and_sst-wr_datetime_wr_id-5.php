...
<link href="../skin/board/basic/style.css__ver-2303229.css" rel="stylesheet"/>
<!--[if lte IE 8]>
...
<h3>자료실</h3>
<ul>
<li class="mbd"><a href="board.php__bo_table-d_01.php">자료실</a></li>
</ul>
...
<span class="page-title-text">자료실</span>
<div class="page-navi">
...
<span class="sound_only">조회</span><strong><i aria-hidden="true" class="fa fa-eye"></i> 170회</strong>
<strong class="if_date"><span class="sound_only">작성일</span><i aria-hidden="true" class="fa fa-clock-o"></i> 24-07-15 22:06</strong>
</div>
</div>
<!-- 게시물 상단 버튼 시작 { -->
<div id="bo_v_top">
<ul class="btn_bo_user bo_v_com">
<li><a class="btn_b01 btn" href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime.php" title="목록"><i aria-hidden="true" class="fa fa-list"></i><span class="sound_only">목록</span></a></li>
</ul>
<script>
...
<!-- 본문 내용 시작 { -->
<div id="bo_v_con"><iframe allowfullscreen="" alt="bLOZaXGhQgI?si=rMUKNS4o2AoVsQZZ" frameborder="0" height="315" src="https://www.youtube.com/embed/bLOZaXGhQgI?si=rMUKNS4o2AoVsQZZ" title="YouTube video player" width="560"></iframe></div>
<!-- } 본문 내용 끝 -->
<!--  추천 비추천 시작 { -->
<!-- }  추천 비추천 끝 -->
</section>
<ul class="bo_v_nb">
<li class="btn_prv"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-up"></i> 이전글</span><a href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime_wr_id-6.php">동영상 자료</a> <span class="nb_date">24.07.15</span></li> <li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime_wr_id-4.php">동영상 자료</a> <span class="nb_date">23.04.26</span></li> </ul>
<script>
// 글자수 제한
