...
<!-- 본문 내용 시작 { -->
<div id="bo_v_con"><iframe allowfullscreen="" alt="Yyq873aCZvc?si=lp1_pcbYYf5tN4mK" frameborder="0" height="315" src="https://www.youtube.com/embed/Yyq873aCZvc?si=lp1_pcbYYf5tN4mK" title="YouTube video player" width="560"></iframe></div>
<!-- } 본문 내용 끝 -->
<!--  추천 비추천 시작 { -->
<!-- }  추천 비추천 끝 -->
</section>
<ul class="bo_v_nb">
<li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime_wr_id-5.php">동영상 자료</a> <span class="nb_date">24.07.15</span></li> </ul>
<script>
// 글자수 제한
