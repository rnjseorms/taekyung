...
<ul class="bo_v_nb">
<li class="btn_prv"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-up"></i> 이전글</span><a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-4.php">동영상 자료</a> <span class="nb_date">23.04.26</span></li> <li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-2.php">동영상 자료</a> <span class="nb_date">23.04.26</span></li> </ul>
<script>
// 글자수 제한
