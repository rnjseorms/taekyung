...
<span class="sound_only">조회</span><strong><i aria-hidden="true" class="fa fa-eye"></i> 188회</strong>
<strong class="if_date"><span class="sound_only">작성일</span><i aria-hidden="true" class="fa fa-clock-o"></i> 23-04-26 15:07</strong>
</div>
</div>
<!-- 게시물 상단 버튼 시작 { -->
<div id="bo_v_top">
...
<!-- 본문 내용 시작 { -->
<div id="bo_v_con"><iframe allowfullscreen="" alt="xbQ_dDoY9xw" frameborder="0" height="315" src="https://www.youtube.com/embed/xbQ_dDoY9xw" title="YouTube video player" width="560"></iframe></div>
<!-- } 본문 내용 끝 -->
<!--  추천 비추천 시작 { -->
<!-- }  추천 비추천 끝 -->
</section>
<ul class="bo_v_nb">
<li class="btn_prv"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-up"></i> 이전글</span><a href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime_wr_id-4.php">동영상 자료</a> <span class="nb_date">23.04.26</span></li> <li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-d_01_page-1_sod-desc_sop-and_sst-wr_datetime_wr_id-2.php">동영상 자료</a> <span class="nb_date">23.04.26</span></li> </ul>
<script>
// 글자수 제한
