...
<input name="bo_table" type="hidden" value="d_01"/>
...
<input name="sst" type="hidden" value="wr_datetime"/>
<input name="sod" type="hidden" value="asc"/>
...
<th scope="col">제목</th>
<th scope="col">글쓴이</th>
<th scope="col"><a href="board.php__bo_table-d_01_page-1_sca-_sfl-_sod-desc_sop-and_sst-wr_hit_stx-.php">조회 </a></th>
<th scope="col"><a href="board.php__bo_table-d_01_page-1_sca-_sfl-_sod-desc_sop-and_sst-wr_datetime_stx-.php">날짜  </a></th>
</tr>
</thead>
<tbody>
<tr class="even">
...
<div class="bo_tit">
<a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-2.php">
                                                                        동영상 자료                    </a>
<i aria-hidden="true" class="fa fa-heart"></i> </div>
</td>
...
<td class="td_subject" style="padding-left:0px">
<div class="bo_tit">
<a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-3.php">
                                                                        동영상 자료                    </a>
<i aria-hidden="true" class="fa fa-heart"></i> </div>
</td>
<td class="td_name sv_use"><span class="sv_member">최고관리자</span></td>
...
<td class="td_subject" style="padding-left:0px">
<div class="bo_tit">
<a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-4.php">
                                                                        동영상 자료                    </a>
<i aria-hidden="true" class="fa fa-heart"></i> </div>
</td>
<td class="td_name sv_use"><span class="sv_member">최고관리자</span></td>
...
<td class="td_subject" style="padding-left:0px">
<div class="bo_tit">
<a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-5.php">
                                                                        동영상 자료                    </a>
<i aria-hidden="true" class="fa fa-heart"></i> </div>
</td>
<td class="td_name sv_use"><span class="sv_member">최고관리자</span></td>
...
<td class="td_subject" style="padding-left:0px">
<div class="bo_tit">
<a href="board.php__bo_table-d_01_page-1_sod-asc_sop-and_sst-wr_datetime_wr_id-6.php">
                                                                        동영상 자료                    </a>
<i aria-hidden="true" class="fa fa-heart"></i> </div>
</td>
<td class="td_name sv_use"><span class="sv_member">최고관리자</span></td>
...
<button class="bo_sch_cls" title="닫기" type="button"><i aria-hidden="true" class="fa fa-times"></i><span class="sound_only">닫기</span></button>
</form>
</fieldset>
