...
<span class="sound_only">조회</span><strong><i aria-hidden="true" class="fa fa-eye"></i> 63회</strong>
...
<ul class="bo_v_nb">
<li class="btn_prv"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-up"></i> 이전글</span><a href="board.php__bo_table-b_01_page-2_wr_id-3.php">사진</a> <span class="nb_date">23.04.26</span></li> <li class="btn_next"><span class="nb_tit"><i aria-hidden="true" class="fa fa-chevron-down"></i> 다음글</span><a href="board.php__bo_table-b_01_page-2_wr_id-1.php">운전 콘트롤박스및 운전선</a> <span class="nb_date">23.04.26</span></li> </ul>
<script>
// 글자수 제한
